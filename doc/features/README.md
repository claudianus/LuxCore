...
| Deformation motion blur (E9, scoped) | [../dev-tools/deformation-motion-blur-design.md](../dev-tools/deformation-motion-blur-design.md) | `bc26dbd45` design doc; `5b1e23fa1` plumbing; `d4dc25e22` Metal HWRT; `d1eb37198` SW MBVH; `c16e19453` Embree | `vertexmotion_test`; `dev-tools/e9_*_vertex_motion_test.py` | Metal HWRT + SW MBVH (OCL/cl2msl) + Embree timesteps |
